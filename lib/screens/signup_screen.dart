...
class _SignupScreenState extends State<SignupScreen> {
  final TextEditingController _usernameController =
      TextEditingController(); // helps to choose username
                ...
                children: [
                  _image != null
                      ? CircleAvatar(
                          radius: 64,
                          backgroundImage:
                              MemoryImage(_image!), // non null memory needed
                          backgroundColor: Colors.red,
                        ) //// to circle around chosen photo like in dp
                      : const CircleAvatar(
                          radius: 64,
                ...
                child: Container(
                  child: !_isLoading
                      ...
                      : const CircularProgressIndicator(
                          color: primaryColor,
                        ), ///// while its checking the firebase ki
                  /// we id present to ni hei tbse phle se, til then
                  /// //// it willl rotate circular rounds of primary color
                  width: double.infinity,
